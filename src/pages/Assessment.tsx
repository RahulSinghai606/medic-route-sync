      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Evaluate and record patient condition
          </p>
        </div>
        ...
        <TabsContent value="vitals">
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <Badge>
                      {vitalsData.bp_systolic > 140 ||
                      vitalsData.bp_diastolic > 90
                        ? "High"
                        : vitalsData.bp_systolic < 90 ||
                          vitalsData.bp_diastolic < 60
                        ? "Low"
                        : "Normal"}
                    </Badge>
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <Badge>
                      {vitalsData.temperature > 37.5
                        ? "Elevated"
                        : vitalsData.temperature < 36.5
                        ? "Low"
                        : "Normal"}
                    </Badge>
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <Badge>
                      {vitalsData.respiratory_rate < 12
                        ? "Low"
                        : vitalsData.respiratory_rate > 20
                        ? "High"
                        : "Normal"}
                    </Badge>
                  </div>
              ...
              {/* Additional Notes */}
              <div className="space-y-2 pt-2 border-t">
                <Label htmlFor="vital-notes" className="text-base">
                  Additional Notes
                </Label>
                <Textarea
                  id="vital-notes"
            ...
            <CardFooter className="flex justify-between">
              <div className="flex items-center gap-2">
                ...
                <Label htmlFor="auto-update">
                  Auto-update from medical devices
                </Label>
              </div>
              <Button className="medical-btn" onClick={handleSaveVitals}>
                Save Vitals
              </Button>
            </CardFooter>
          </Card>
        ...
        <TabsContent value="patient">
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handlePatientDataChange("name", e.target.value)
                    }
                  />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="patient-age" className="text-base">
                    Age
                  </Label>
                  <Input
                    id="patient-age"
                ...
                <div className="space-y-2">
                  <Label htmlFor="patient-gender" className="text-base">
                    Gender
                  </Label>
                  <select
                    id="patient-gender"
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handlePatientDataChange("patient_id", e.target.value)
                    }
                    readOnly
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handlePatientDataChange("phone", e.target.value)
                    }
                  />
                </div>
              </div>
              ...
              <div className="space-y-2 pt-2 border-t">
                <Label htmlFor="patient-address" className="text-base">
                  Address
                </Label>
                <Textarea
                  id="patient-address"
                  ...
                  onChange={(e) =>
                    handlePatientDataChange("address", e.target.value)
                  }
                />
              </div>

              <div className="space-y-2 pt-2 border-t">
                <Label htmlFor="emergency-contact" className="text-base">
                  Emergency Contact
                </Label>
                <Input
                  ...
                  onChange={(e) =>
                    handlePatientDataChange("emergency_contact", e.target.value)
                  }
                />
                <Input
        ...
        <TabsContent value="incident">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Record information about the emergency incident
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleIncidentDataChange("incident_type", e.target.value)
                    }
                  >
                ...
                <div className="space-y-2">
                  <Label htmlFor="incident-date" className="text-base">
                    Date & Time
                  </Label>
                  <Input
                    id="incident-date"
                    ...
                    onChange={(e) =>
                      handleIncidentDataChange("incident_date", e.target.value)
                    }
                  />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="incident-severity" className="text-base">
                    Incident Severity
                  </Label>
                  <select
              ...
              <div className="space-y-2 pt-2 border-t">
                <Label htmlFor="chief-complaint" className="text-base">
                  Chief Complaint
                </Label>
                <Textarea
                  id="chief-complaint"
                  ...
                  onChange={(e) =>
                    handleIncidentDataChange("chief_complaint", e.target.value)
                  }
                />
              </div>

              <div className="space-y-2 pt-2">
                <Label htmlFor="incident-description" className="text-base">
                  ...
                  {[
                    ...
                    <div key={intervention} className="flex items-center gap-2">
                      <input
                        ...
                        className="h-4 w-4"
                        checked={incidentData.interventions.includes(
                          intervention
                        )}
                        onChange={(e) =>
        ...
        <TabsContent value="history">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Record patient's medical history if available
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
                  ...
                  {[
                    ...
                    <div key={condition} className="flex items-center gap-2">
                      <input
                        ...
                        className="h-4 w-4"
                        checked={medicalHistoryData.conditions.includes(
                          condition
                        )}
                        onChange={(e) =>
                          handleCheckboxChange(
              ...
              <div className="space-y-2 pt-2 border-t">
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    handleMedicalHistoryChange("medications", e.target.value)
                  }
                />
              </div>

              <div className="space-y-2 pt-2 border-t">
                <Label htmlFor="surgical-history" className="text-base">
                  Surgical History
                </Label>
                <Textarea
                  id="surgical-history"
              ...
              <div className="space-y-2 pt-2 border-t">
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    handleMedicalHistoryChange("family_history", e.target.value)
                  }
                />
              </div>
                  ...
                  {[
                    ...
                    <div key={factor} className="flex items-center gap-2">
                      <input
                        ...
                        id={`factor-${factor}`}
                        className="h-4 w-4"
                        checked={medicalHistoryData.additional_factors.includes(
                          factor
                        )}
                        onChange={(e) =>
                          handleCheckboxChange(
